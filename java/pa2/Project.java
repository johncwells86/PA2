...
public class Project {
	public final static void main(String[] argv) {
		StudentNetworkSimulatorAB simulator;
		...
		// MODIFIED BY JOHN WELLS TO IMPLEMENT COMMAND LINE SWITCHING ARGUMENTS.
		// NO OTHER CODE WAS TOUCHED. FURTHER DETAILS IN DOCUMENTATION.
		
		simulator = new StudentNetworkSimulatorAB(nsim, loss, corrupt, delay, trace, seed);
